...
public class DiscoveryModel implements BaseModel
{
    ...
    private static final DiscoveryModel discoveryService = new DiscoveryModel();
    ...
    {
        var GET_DISCOVERY_PROFILE_BY_ID_QUERY =
                "SELECT * FROM discovery_profiles" +
                        " WHERE id = $1;";

        return PostgresQuery
                .execute(GET_DISCOVERY_PROFILE_BY_ID_QUERY, params)
                .map(PostgresQuery::toJsonArray);
    }

    public Future<JsonArray> getWithCredentialsById(JsonArray params)
    {
        var GET_DISCOVERY_PROFILES_WITH_CREDENTIALS_BY_ID_QUERY =
                "SELECT" +
                        "    dp.id AS id," +
                        "    dp.name AS name," +
                        "    dp.ip AS ip," +
        ...
        return PostgresQuery
                .execute(GET_DISCOVERY_PROFILES_WITH_CREDENTIALS_BY_ID_QUERY, params)
                .map(PostgresQuery::toJsonArray);
    }

    public Future<JsonArray> getWithResultsById(JsonArray params)
    {
        var GET_DISCOVERY_WITH_RESULTS_BY_ID_QUERY =
                "SELECT" +
                        "    dp.id AS id," +
                        "    dp.name AS name," +
                        "    dp.ip AS ip," +
        ...
        return PostgresQuery
                .execute(GET_DISCOVERY_WITH_RESULTS_BY_ID_QUERY, params)
                .map(PostgresQuery::toJsonArray);
    }
    ...
    {
        var GET_ALL_DISCOVERY_PROFILES_QUERY =
                "SELECT * FROM discovery_profiles;";

        return PostgresQuery
                .execute(GET_ALL_DISCOVERY_PROFILES_QUERY)
                .map(PostgresQuery::toJsonArray);
    }

    public Future<JsonArray> getAllWithCredentials()
    {
        var GET_ALL_DISCOVERY_PROFILES_WITH_CREDENTIALS_QUERY =
                "SELECT" +
                        "    dp.id AS id," +
                        "    dp.name AS name," +
                        "    dp.ip AS ip," +
        ...
        return PostgresQuery
                .execute(GET_ALL_DISCOVERY_PROFILES_WITH_CREDENTIALS_QUERY)
                .map(PostgresQuery::toJsonArray);
    }

    public Future<JsonArray> getAllWithResults()
    {
        var GET_ALL_DISCOVERIES_WITH_RESULTS_QUERY =
                "SELECT" +
        ...
        return PostgresQuery
                .execute(GET_ALL_DISCOVERIES_WITH_RESULTS_QUERY)
                .map(PostgresQuery::toJsonArray);
    }
    ...
    {
        var CREATE_DISCOVERY_PROFILE_QUERY =
        ...
        return PostgresQuery
                .execute(CREATE_DISCOVERY_PROFILE_QUERY, params)
                .map(PostgresQuery::toJsonArray);
    }

    public Future<JsonArray> saveResults(List<Tuple> params)
    {
        var CREATE_DISCOVERY_RESULTS_IN_BATCH_QUERY =
        ...
        return PostgresQuery
                .execute(CREATE_DISCOVERY_RESULTS_IN_BATCH_QUERY, params)
                .map(PostgresQuery::toJsonArray);
    }

    public Future<JsonArray> saveCredentials(List<Tuple> params)
    {
        var CREATE_DISCOVERY_CREDENTIALS_IN_BATCH_QUERY =
        ...
        return PostgresQuery
                .execute(CREATE_DISCOVERY_CREDENTIALS_IN_BATCH_QUERY, params)
                .map(PostgresQuery::toJsonArray);
    }
    @Override
    public Future<JsonArray> update(JsonArray params)
    {
        var UPDATE_DISCOVERY_PROFILE_IF_NOT_COMPLETED_QUERY =
        ...
        return PostgresQuery
                .execute(UPDATE_DISCOVERY_PROFILE_IF_NOT_COMPLETED_QUERY, params)
                .map(PostgresQuery::toJsonArray);
    }

    public Future<JsonArray> updateStatus(JsonArray params)
    {
        var UPDATE_DISCOVERY_PROFILE_STATUS_QUERY =
                "UPDATE discovery_profiles" +
                        " SET status = $2" +
                        " WHERE id = $1" +
                        " RETURNING *;";
        ...
        return PostgresQuery
                .execute(UPDATE_DISCOVERY_PROFILE_STATUS_QUERY, params)
                .map(PostgresQuery::toJsonArray);
    }
    ...
    {
        var DELETE_DISCOVERY_PROFILE_WITH_CREDENTIALS_AND_RESULTS_QUERY =
                "DELETE FROM discovery_profiles" +
                        " WHERE id = $1" +
                        " RETURNING id, name, ip, ip_type;";

        return PostgresQuery
                .execute(DELETE_DISCOVERY_PROFILE_WITH_CREDENTIALS_AND_RESULTS_QUERY, params)
                .map(PostgresQuery::toJsonArray);
    }

    public Future<JsonArray> deleteCredentials(List<Tuple> params)
    {
        var DELETE_DISCOVERY_CREDENTIALS_QUERY =
        ...
        return PostgresQuery
                .execute(DELETE_DISCOVERY_CREDENTIALS_QUERY, params)
                                .map(PostgresQuery::toJsonArray);
    }
}
