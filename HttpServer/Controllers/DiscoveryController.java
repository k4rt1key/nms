...
public class DiscoveryController
{
    ...
    public static void runDiscovery(RoutingContext ctx)
    {
        ...
        App.discoveryService.getWithCredentialsById(new JsonArray().add(id))
                .compose(discoveryWithCredentials ->
                {
                    ...
                    var ipArray = IpUtility.getIpListAsJsonArray(ips, ipType);

                    // Step 2.1: Ping Check - Direct implementation instead of eventbus
                    return executeBlockingWithRetry(vertx -> IpUtility.pingIps(ipArray))
                            .compose(pingResults ->
                            {
